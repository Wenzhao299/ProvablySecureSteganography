"""Baseline normal sampling implementation without steganographic embedding."""
...
def encode(
    model, enc, context_tokens, max_tokens, top_p=1.0, top_k=0, temp=1.0, device="cuda"
):
    """
    ...
    context_tensor = torch.tensor(
        context_tokens[-1022:], device=device, dtype=torch.long
    )
